...
```{r angel, echo = FALSE}
angel_research <- resq_merge
angel_research <- filter(angel_research, angel_research$door_to_groin < 99)
p <- ggplot(angel_research, aes(angel_research$discharge_date, angel_research$door_to_needle))
p + geom_point()
