...
p_dtn <- ggplot(resq_mort[resq_mort$door_to_needle<99,], aes(x = Mortality30d, y = door_to_needle, color=as.factor(discharge_date))) + geom_boxplot() + geom_jitter() + theme_bw()


p_dtg <- ggplot(resq_mort[resq_mort$door_to_groin<99,], aes(x = Mortality30d, y = door_to_groin, color=as.factor(discharge_date))) + geom_boxplot() + geom_jitter() + theme_bw()
