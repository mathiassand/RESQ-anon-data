...
p_nihss_score <- ggplot(resq_mort[resq_mort$nihss_score<99 & resq_mort$discharge_date<2201,], aes(x = Mortality30d, y = nihss_score, color=as.factor(discharge_date))) + geom_violin() + geom_jitter() + theme_bw()

#this might have way too many dots to show. decreases readability
p_dis_mrs_jitter <- ggplot(resq_mort[resq_mort$discharge_mrs>1 & resq_mort$discharge_mrs<99 & resq_mort$discharge_date<2201,], aes(x = Mortality30d, y = discharge_mrs, color=as.factor(discharge_date))) + geom_boxplot() + geom_jitter() + theme_bw()

p_dis_mrs <- ggplot(resq_mort[resq_mort$discharge_mrs>1 & resq_mort$discharge_mrs<99 & resq_mort$discharge_date<2201,], aes(x = Mortality30d, y = discharge_mrs, color=as.factor(discharge_date))) + geom_boxplot() + theme_bw()
